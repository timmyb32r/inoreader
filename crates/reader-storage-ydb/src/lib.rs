...
pub const SCHEMA_DDL: &[&str] = &[
    "CREATE TABLE IF NOT EXISTS schema_metadata (id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (id))",
    ...
    "CREATE TABLE IF NOT EXISTS jobs (id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (id))",
    "CREATE TABLE IF NOT EXISTS outbox (id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (id))",
    ...
    "CREATE TABLE IF NOT EXISTS accounts (id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (id))",
    "CREATE TABLE IF NOT EXISTS username_reservations (id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (id))",
    "CREATE TABLE IF NOT EXISTS invites (id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (id))",
    "CREATE TABLE IF NOT EXISTS sessions (id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (id))",
    "CREATE TABLE IF NOT EXISTS password_resets (id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (id))",
    "CREATE TABLE IF NOT EXISTS login_attempts (id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (id))",
    "CREATE TABLE IF NOT EXISTS rules (id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (id))",
    "CREATE TABLE IF NOT EXISTS web_feed_recipes (id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (id))",
    "CREATE TABLE IF NOT EXISTS sources (id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (id))",
    "CREATE TABLE IF NOT EXISTS source_records (id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (id))",
    "CREATE TABLE IF NOT EXISTS delivery_origins (id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (id))",
    "CREATE TABLE IF NOT EXISTS content_chunks (id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (id))",
    "CREATE TABLE IF NOT EXISTS content_refresh_state (id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (id))",
    "CREATE TABLE IF NOT EXISTS ingest_jobs (id Utf8 NOT NULL, status Utf8 NOT NULL, run_at_ms Int64 NOT NULL, first_attempt_ms Int64 NOT NULL, origin_key Utf8 NOT NULL, attempt Uint32 NOT NULL, lease_token Utf8, lease_deadline_ms Int64, item Utf8 NOT NULL, revision Uint64 NOT NULL, diagnostic Utf8, PRIMARY KEY (id), INDEX ready_jobs GLOBAL ON (status, run_at_ms), INDEX leased_by_origin GLOBAL ON (status, origin_key, lease_deadline_ms))",
    "CREATE TABLE IF NOT EXISTS source_record_identity (source_id Utf8 NOT NULL, upstream_id Utf8 NOT NULL, record_id Utf8 NOT NULL, observed_at_ms Int64 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (source_id, upstream_id), INDEX recent_by_source GLOBAL ON (source_id, observed_at_ms))",
    "CREATE TABLE IF NOT EXISTS library_dedup (workspace_id Utf8 NOT NULL, dedup_key Utf8 NOT NULL, article_id Utf8 NOT NULL, revision Uint64 NOT NULL, document Utf8 NOT NULL, PRIMARY KEY (workspace_id, dedup_key))",
    "CREATE TABLE IF NOT EXISTS library_origins (workspace_id Utf8 NOT NULL, article_id Utf8 NOT NULL, subscription_id Utf8 NOT NULL, source_record_id Utf8 NOT NULL, PRIMARY KEY (workspace_id, article_id, subscription_id, source_record_id), INDEX by_subscription GLOBAL ON (subscription_id, workspace_id))",
